...
impl PendingAppServerRequests {
    ...
    pub(super) fn begin_inline_visualization_compile(
        ...
        // Compiler errors arrive while the turn is active. Bound correction to one initial compile
        // plus two retries so malformed output cannot create an unbounded model/tool loop.
